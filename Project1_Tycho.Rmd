...
corrplot(cor_spring, method = "color", addCoef.col = "black", 
         title = "Correlation Matrix for Spring", number.cex = 0.7, 
...
corrplot(cor_summer, method = "color", addCoef.col = "black", 
         title = "Correlation Matrix for Summer", number.cex = 0.7, 
         tl.cex = 0.8, mar = c(0, 0, 2, 0))
...
corrplot(cor_fall, method = "color", addCoef.col = "black", 
         title = "Correlation Matrix for Fall", number.cex = 0.7, 
         tl.cex = 0.8, mar = c(0, 0, 2, 0))
...
corrplot(cor_winter, method = "color", addCoef.col = "black", 
         title = "Correlation Matrix for Winter", number.cex = 0.7, 
         tl.cex = 0.8, mar = c(0, 0, 2, 0))
```
