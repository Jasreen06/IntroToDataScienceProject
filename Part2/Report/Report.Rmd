...
```{r}
rf_model <- randomForest(booking_status_binary ~ avg_price_per_room + lead_time + no_of_special_requests + 
...
confusionMatrix(predictions, hotel_data$booking_status_binary, positive = "1")
```
...
conf_matrix <- table(Actual = data$booking_status, Predicted = data$predicted_class)
