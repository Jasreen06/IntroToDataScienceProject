...
1. The lead_time coefficient is positive and statistically significant (p-value < 2e-16), indicating that as the lead time increases, the likelihood of booking cancellation also increases.\
2. Other significant factors include the number of adults, number of children, market segment type, number of previous cancellations, and number of special requests.\
...
```
**1. Accuracy:** 0.786, meaning the model correctly classifies 78.6% of the bookings.\
**2. Precision:** 0.733, indicating that 73.3% of the predictions of canceled bookings are correct.\
**3. Recall:** 0.551, meaning the model correctly identifies 55.1% of the actual canceled bookings.\
**4. F1-Score:** 0.629, which is the harmonic mean of precision and recall, providing a balanced evaluation of the model's performance.\
...
```
Area Under the ROC Curve (AUC): 0.848, suggesting the model has good discriminative power in predicting booking cancellations.\
...
## **5. Can we predict peak booking times and high-demand periods?**
