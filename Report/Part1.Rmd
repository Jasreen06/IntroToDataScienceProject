...
## **5th SMART Question**
**Null Hypothesis (H₀):**: There is no significant relationship between lead time and booking status. This means that lead time has no predictive power or influence on whether a booking is canceled or not.
**Alternative Hypothesis (H₁):**: There is a significant relationship between lead time and booking status. This implies that as lead time increases, it affects the likelihood of a booking being canceled or not.

```{r test5, fig.width=10, fig.height=10}
...
corrplot(cor_data, method = "color", addCoef.col = "black", 
         title = "Correlation Matrix for Hotel Dataset", number.cex = 1, 
